...
public class SyncManagerImpl implements ChronoSync2013.OnInitialized,
    ...
    private static int PROCESS_INTERVAL = 30000;
    ...
    /** Runnable used to startCheckFib the JndnProcessEventTask. */
    ...
    private ArrayList<String> mInterestExpressed = new ArrayList<>();
