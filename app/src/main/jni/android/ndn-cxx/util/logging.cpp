...
void Logging::addLoggerImpl(Logger& logger) {
...
void Logging::setLevelImpl(const std::string& moduleName, LogLevel level) {
  std::lock_guard<std::mutex> lock(m_mutex);
...
void Logging::setDefaultLevel(LogLevel level) {
...
void Logging::setLevelImpl(const std::string& config) {
